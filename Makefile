...
MODULES		+= espfs httpd user serial cmd esp-link avrisp
...
dump:
	xtensa-lx106-elf-objdump -Ds ${USER1_OUT} >${USER1_OUT}.dump
	xtensa-lx106-elf-objdump -Ds ${USER2_OUT} >${USER2_OUT}.dump
